...
filewd_fillrate_resumo_2 <-  paste0("C:\\Users\\Repro\\Documents\\R\\LOGISTICA\\FILLRATE\\BASES\\fillrate_resumo_2","_",format(Sys.Date(),"%d_%m_%y"),".RData")
...
filewd_fillrate_calc<-  paste0("C:\\Users\\Repro\\Documents\\R\\LOGISTICA\\FILLRATE\\BASES\\fillrate_calc","_",format(Sys.Date(),"%d_%m_%y"),".RData")
...
#RESUMO
filewd_fillrate_resumo <-  paste0("C:\\Users\\Repro\\Documents\\R\\LOGISTICA\\FILLRATE\\BASES\\fillrate_resumo_2","_",format(Sys.Date(),"%d_%m_%y"),".RData")
...
mymail_fillrate <- gm_mime() %>% 
  gm_to("sandro.jakoska@repro.com.br,carlos.machado@repro.com.br,debora.rocha@repro.com.br,silvano.silva@repro.com.br") %>% 
